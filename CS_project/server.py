...
from server.database_storage import ServerStorage
...
# Эта часть нам больше не нужна, мы работаем с аутентификацией...
# Флаг что был подключён новый пользователь, для снижения нагрузки на БД
# предотвращаем постоянные запросы на обновление
